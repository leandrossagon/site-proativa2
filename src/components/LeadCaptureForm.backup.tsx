...
import { CheckCircle2, MessageCircle, Send, ArrowRight } from 'lucide-react';
...
export const LeadCaptureForm: React.FC<LeadCaptureFormProps> = ({
  ...
  return (
    <div className="max-w-2xl mx-auto glass-panel-elevated rounded-2xl p-6 sm:p-8 text-white shadow-2xl border border-white/15 relative overflow-hidden my-8" id="orcamento">
